                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '1901jfi0' /* Send Contract Confirmation */,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '7u0jwzjw' /* A new contract has been genera... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '15b4ett8' /* Send the information below. An... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
