...
class TrungTamAPI {
  final String baseUrl =
      'https://handtaitech-a0952bbd1beb.herokuapp.com/v1/trungtam';
...
class GiaoVienAPI {
  final String baseUrl =
      'https://handtaitech-a0952bbd1beb.herokuapp.com/v1/giaovien';
...
class HocVienAPI {
  final String baseUrl =
      'https://handtaitech-a0952bbd1beb.herokuapp.com/v1/hocvien';
