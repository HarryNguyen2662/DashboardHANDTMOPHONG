                                                        ...
                                                        children: [
                                                          Text(
                                                            /*FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'c556deyt' /* Số lượng giáo viên đã kích hoạ... */,
                                                            ),*/
                                                            "Số lượng học viên đã kích hoạt",
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                                .override(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'tz604db1' /* Below is an a summary of activ... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
